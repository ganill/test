...
class RegistersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create register" do
    assert_difference('Register.count') do
      post registers_url, params: { register: { Email: @register.Email, Fathername: @register.Fathername, Firatname: @register.Firatname, lastName: @register.lastName, mothername: @register.mothername, phone: @register.phone } }
    end
  ...
  test "should update register" do
    patch register_url(@register), params: { register: { Email: @register.Email, Fathername: @register.Fathername, Firatname: @register.Firatname, lastName: @register.lastName, mothername: @register.mothername, phone: @register.phone } }
